...
on run argv
	...
	with timeout of (480 * 60) seconds
		tell application "EyeTV.app"
			...
			set show_title to Çclass TitlÈ of Çclass cRecÈ id myid as text
			set show_description to Çclass PdscÈ of Çclass cRecÈ id myid as text
			...
			set show_episode to (my format_episode(Çclass EpisÈ of Çclass cRecÈ id myid as text, Çclass StimÈ of Çclass cRecÈ id myid))
			
			--episode of recording id myid as text
			set thisEpisode to (Çclass EpisÈ of Çclass cRecÈ id myid as text)
		end tell
		...
		tell application "EyeTV.app"
			...
			set input_file to my recording_path((URL of Çclass cRecÈ id myid as text))
